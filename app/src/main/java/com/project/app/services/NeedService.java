...
import com.project.app.models.repositories.NeedRepository;
...
public class NeedService {
    ...
    public Need createNeed(NeedDTO dto) {
        // 1. Buscar o dono da necessidade pelo CPF
        Optional<Users> userOptional = usersRepository.findByCpf(dto.getUserCpf());
